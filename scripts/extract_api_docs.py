...
DEFAULT_CLASSES = [
    # Base providers (abstract)
    "fin_infra.providers.base.MarketDataProvider",
    "fin_infra.providers.base.CryptoDataProvider",
    "fin_infra.providers.base.BankingProvider",
    "fin_infra.providers.base.BrokerageProvider",
    "fin_infra.providers.base.CreditProvider",
    "fin_infra.providers.base.TaxProvider",
    "fin_infra.providers.base.InvestmentProvider",
    # Provider registry
    "fin_infra.providers.registry.ProviderRegistry",
    # Analytics
    "fin_infra.analytics.ease.AnalyticsEngine",
    # Categorization
    "fin_infra.categorization.engine.CategorizationEngine",
    # Net worth
    "fin_infra.net_worth.ease.NetWorthTracker",
    "fin_infra.net_worth.aggregator.NetWorthAggregator",
    # Goals
    "fin_infra.goals.management.FinancialGoalTracker",
    # Budgets
    "fin_infra.budgets.tracker.BudgetTracker",
    # Documents
    "fin_infra.documents.ease.FinancialDocumentManager",
    # Exceptions
    "fin_infra.exceptions.FinInfraError",
    "fin_infra.exceptions.ProviderError",
    "fin_infra.exceptions.ValidationError",
]
...
def load_class(class_path: str, search_paths: list[Path]) -> Class | None:
    """Load a class from a module path like 'fin_infra.analytics.AnalyticsEngine'."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Comma-separated list of classes to extract (e.g., fin_infra.analytics.AnalyticsEngine)",
    )
    parser.add_argument(
        "--src-dir",
        type=Path,
