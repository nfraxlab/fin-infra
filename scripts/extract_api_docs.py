...
fin_infra/__init__.py and extracts docstrings, signatures, parameters,
...
ADDITIONAL_SUBMODULES = [
    ...
    "fin_infra.budgets",
    "fin_infra.cashflows",
    "fin_infra.categorization",
    "fin_infra.investments",
    "fin_infra.net_worth",
    "fin_infra.recurring",
    "fin_infra.tax",
]
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=str,
        default="fin_infra",
        help="Package to discover classes from (default: fin_infra)",
    )
