...
class TestGoogleGeminiLLM:
    ...
    async def test_google_gemini_basic(self):
        ...
        print(f"✅ Google Gemini: {result.merchant_name} → {result.category} (confidence: {result.confidence:.2f})")
...
class TestOpenAIGPT4oMini:
    ...
    async def test_openai_gpt4o_mini_basic(self):
        ...
        print(f"✅ OpenAI GPT-4o-mini: {result.merchant_name} → {result.category} (confidence: {result.confidence:.2f})")
...
class TestAnthropicClaude:
    ...
    async def test_anthropic_claude_basic(self):
        ...
        print(f"✅ Anthropic Claude: {result.merchant_name} → {result.category} (confidence: {result.confidence:.2f})")
...
class TestHybridWithLLM:
    ...
    async def test_hybrid_flow(self):
        ...
        print(f"✅ Hybrid flow test passed:")
